...
module Phcpress
  RSpec.describe News::PostsController, type: :controller do

    # This should return the minimal set of attributes required to create a valid
    # News::Post. As you add validations to News::Post, be sure to
    ...
    # News::PostsController. Be sure to keep this updated too.
    let(:valid_session) { {} }
