...
module Phcpress
  RSpec.describe Blog::PostsController, type: :controller do
    ...
    # Define Fields to be Posted
    let(:valid_update_attributes) { {blogpsttitle: 'Blog Title', blogpsttext: 'Text'} }
    
    # Define Fields to Update Record
    let(:expected_update_attributes) { valid_update_attributes.merge}
